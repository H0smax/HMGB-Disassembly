...
Jump_000_024d:
    ld a, [wActivateTransitionBetweenMaps_TBD]
...
Jump_000_0304:
    ...
    ldh [$ff97], a
    ld [$c500], a
    call SetCameraAndWindow_TBD
    call SetCurrentPalettes_TBD
    xor a
    ldh [$ff99], a
    call Call_000_2444
    ld a, [$c0a8]
...
jr_000_2046:
    ...
    ldh [$ff8b], a
    ld a, c
    ldh [hPressedButtons_TBD], a
    ldh [hPressedButtons_2_TBD], a
    ld a, $30
    ldh [rP1], a
    ret
